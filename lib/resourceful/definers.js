...
module.exports = {
  all: {
    define: function (attr, val /*, condition, options */) {
      ...
      if (options.message) {
        if (!this.property.messages) this.property.messages = {};
        this.property.messages[attr] = options.message;
      }
      if (options.condition) {
        if (!this.property.conditions) this.property.conditions = {};
        this.property.conditions[attr] = condition;
      }
